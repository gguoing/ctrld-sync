...
FOLDER_URLS = [
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/apple-private-relay-allow-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/badware-hoster-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-amazon-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-apple-folder.json"
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-huawei-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-lgwebos-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-microsoft-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-oppo-realme-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-roku-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-samsung-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-tiktok-aggressive-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-tiktok-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-vivo-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/native-tracker-xiaomi-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/referral-allow-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/spam-idns-folder.json",
    "https://github.com/hagezi/dns-blocklists/blob/main/controld/spam-tlds-combined-folder.json",
